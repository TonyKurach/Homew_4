...
class Book:
    ...
    #прописываем инициализатор с полями класса -
    # в данном случае мы указываем методы экземпляра класса
...
print("Количество книг в каталоге: ")
print(Book.get_count_id())
